...
def index(request):
    ...
    # Generate counts for genres and books that contain a particular world
    # case insensitive
    # orwell_books = Book.objects.filter(author__last_name__icontains='Orwell').count()
    # science_fiction = Genre.objects.filter(name__icontains='science fiction').count()
